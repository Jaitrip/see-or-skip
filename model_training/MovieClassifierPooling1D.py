...
sentiment_analysis_model.add(layers.Dense(128, activation='relu'))
...
history = sentiment_analysis_model.fit(training_data, epochs=3, validation_data=test_data, validation_steps=30, callbacks=[tensorboard_callback])
...
tf.keras.models.save_model(sentiment_analysis_model, '../models/movie_sentiment_pooling.h5')